  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        'border backdrop-blur-sm group cursor-pointer overflow-hidden',
        isSelected
          ? 'border-nexus-gold/50 bg-nexus-gold/5 glow-gold'
          : 'border-nexus-emerald/20 bg-nexus-dark/40 hover:border-nexus-gold/30 hover:bg-nexus-dark/60'
      )}
    >
